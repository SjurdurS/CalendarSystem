\begin{versionhistory}
  ...
  \newline Updated \textit{UML Class diagram}.
  \newline Updated \textit{Component diagram}.
  \newline Updated \textit{subsystem decomposition} description.
  \newline Updated \textit{Hardware/software mapping} description.
  \newline Updated \textit{Global software control} description.
  \newline Updated \textit{subsystem services} description.}
